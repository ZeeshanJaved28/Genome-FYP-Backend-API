...
disorder_subclass_model = joblib.load('models\\Disorder_Subclass_Stacked_Model.pkl.gz')
combined_disorder_model = joblib.load('models\\Combined_Genome_Disorder_Stacked_Model.pkl.gz')
