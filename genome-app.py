...
# disorder_subclass_model = joblib.load(os.path.join('models', 'Disorder_Subclass_Stacked_Model.pkl.xz'))
combined_disorder_model = joblib.load(os.path.join('models', 'Combined_Genome_Disorder_Stacked_Model.pkl.xz'))
